...
En esa misma pantalla puedes:

- Dar permiso de ingreso en **Solicitudes pendientes**.
- Editar nombre, correo, rol, cargo, teléfono o contraseña.
- Eliminar/desactivar usuarios para que ya no puedan ingresar.
